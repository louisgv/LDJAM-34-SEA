...
public class SteamVR_Controller
{
	...
	public class Device
	{
		...
		public Vector3 velocity {
			get {
				Update ();
				return new Vector3 (pose.vVelocity.v [0], pose.vVelocity.v [1], -pose.vVelocity.v [2]);
			}
		}
		...
		public Vector3 angularVelocity {
			get {
				Update ();
				return new Vector3 (-pose.vAngularVelocity.v [0], -pose.vAngularVelocity.v [1], pose.vAngularVelocity.v [2]);
			}
		}
